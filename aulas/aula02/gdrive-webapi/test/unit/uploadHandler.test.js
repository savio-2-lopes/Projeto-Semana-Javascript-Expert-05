...
describe('#UploadHandler test suite', () => {
  ...
  describe('#onFile', () => {
    test('given a stream file it shoul save it on disk', async () => {
      ...
      const onTranform = jest.fn()
      jest.spyOn(handler, handler.handleFileBytes.name)
        .mockImplementation(() => TestUtil.generateTransformStream(onTranform))
      ...
      expect(onTranform.mock.calls.join()).toEqual(chunks.join())
  ...
  describe('#canExecute', () => {
    ...
    test('should return false true when time isnt later than specified delay', () => {
